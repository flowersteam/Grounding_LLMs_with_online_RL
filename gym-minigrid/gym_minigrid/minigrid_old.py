            ...
            for i in view_field_dictionary.keys():
                for j in view_field_dictionary[i].keys():
                    if i != agent_pos_vx or j != agent_pos_vy:
                        ...
                        if agent_pos_vy - j > 0:
                            relative_position["y_axis"] = ("in front", agent_pos_vy - j)
                        elif agent_pos_vy - j == 0:
                            relative_position["y_axis"] = ("in front", 0)

                        if object[0] != 4:  # if it is not a door
                            if relative_position["x_axis"][0] == "face":
                                list_textual_descriptions.append(
                                    "A {} {} is {} step {}".format(IDX_TO_COLOR[object[1]],
                                                                   IDX_TO_OBJECT[object[0]],
                                                                   relative_position["y_axis"][1],
                                                                   relative_position["y_axis"][0]))
                            else:
                                if relative_position["y_axis"][1] == 0:
                                    list_textual_descriptions.append(
                                        "A {} {} is {} step {}".format(IDX_TO_COLOR[object[1]],
                                                                       IDX_TO_OBJECT[object[0]],
                                    ...
                                    list_textual_descriptions.append(
                                        "A {} {} is {} step {} and {} step {}".format(IDX_TO_COLOR[object[1]],
                                                                                      IDX_TO_OBJECT[object[0]],
                                                                                      relative_position["x_axis"][1],
                                                                                      relative_position["x_axis"][0],
                                                                                      relative_position["y_axis"][1],
                            ...
                            if IDX_TO_STATE[object[2]] != 0:  # if it is not open
                                if relative_position["x_axis"][0] == "face":
                                    list_textual_descriptions.append(
                                        "A {} {} {} is {} step {}".format(IDX_TO_STATE[object[2]],
                                                                          IDX_TO_COLOR[object[1]],
                                                                          IDX_TO_OBJECT[object[0]],
                                                                          relative_position["y_axis"][1],
                                                                          relative_position["y_axis"][0]))
                                    ...
                                    if relative_position["y_axis"][1] == 0:
                                        ...
                                        list_textual_descriptions.append(
                                            "A {} {} {} is {} step {} and {} step {}".format(IDX_TO_STATE[object[2]],
                                                                                             IDX_TO_COLOR[object[1]],
                                                                                             IDX_TO_OBJECT[object[0]],
                                                                                             relative_position[
                                                                                                 "x_axis"][1],
                                ...
                                if relative_position["x_axis"][0] == "face":
                                    list_textual_descriptions.append(
                                        "An {} {} {} is {} step {}".format(IDX_TO_STATE[object[2]],
                                                                           IDX_TO_COLOR[object[1]],
                                                                           IDX_TO_OBJECT[object[0]],
                                                                           relative_position["y_axis"][1],
                                                                           relative_position["y_axis"][0]))
                                    ...
                                    if relative_position["y_axis"][1] == 0:
                                        ...
                                        list_textual_descriptions.append(
                                            "An {} {} {} is {} step {} and {} step {}".format(IDX_TO_STATE[object[2]],
                                                                                              IDX_TO_COLOR[object[1]],
                                                                                              IDX_TO_OBJECT[object[0]],
                                                                                              relative_position[
                                                                                                  "x_axis"][1],
