...
class FullyObsImgDirWrapper(FullyObsWrapper):
    """
    Fully observable gridworld using a compact grid encoding and direction
    """
...
class FullyObsImgEgoWrapper(FullyObsWrapper):
    """
    Fully observable gridworld using a compact grid encoding and direction
    """
    ...
    def observation(self, obs):
        ...
        full_grid = np.rot90(full_grid, (obs['direction'] + 1), (1,0))
